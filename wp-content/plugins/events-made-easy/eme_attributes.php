...
function eme_attributes_form($eme_array) {
   ...
   <?php if( count( $attributes ) > 0 ) { ?> 
      ...
      <table class="form-table eme_attributes">
            ...
            if( is_array($eme_data) and count($eme_data) > 0){
               foreach( $eme_data as $name => $value){
                  ...
                  <tr id="mtm_<?php echo $count ?>">
                     ...
                     <td>
			<textarea rows="2" cols="40" id="mtm_<?php echo $count; ?>_id" name="mtm_<?php echo $count; ?>_name"><?php echo eme_esc_html($value); ?></textarea>
                     </td>
                  </tr>
                  <?php
                  $count++;
         ...
         <tfoot>
            <tr>
               <td colspan="2"><a href="#" id="mtm_add_tag"><?php _e('Add new tag','events-made-easy'); ?></a></td>
            </tr>
         </tfoot>
      </table>
   <?php
